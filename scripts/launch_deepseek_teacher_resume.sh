...
export DELTA_NLA_TEACHER_MAX_IN_FLIGHT="${DELTA_NLA_TEACHER_MAX_IN_FLIGHT:-$DELTA_NLA_TEACHER_BATCH_SIZE}"
export DELTA_NLA_TEACHER_ROLLING_QUEUE="${DELTA_NLA_TEACHER_ROLLING_QUEUE:-0}"
export DELTA_NLA_TEACHER_REQUEST_WINDOW="${DELTA_NLA_TEACHER_REQUEST_WINDOW:-256}"
export DELTA_NLA_TEACHER_RETRY_TOKEN_INCREMENT="${DELTA_NLA_TEACHER_RETRY_TOKEN_INCREMENT:-64}"
export DELTA_NLA_TEACHER_QUARANTINE_EXHAUSTED="${DELTA_NLA_TEACHER_QUARANTINE_EXHAUSTED:-1}"
# Stop rather than silently shrinking SFT by more than 0.5% of 50k labels.
export DELTA_NLA_TEACHER_MAX_QUARANTINED="${DELTA_NLA_TEACHER_MAX_QUARANTINED:-250}"
